  ...
  return (
    <div className="space-y-20 py-4 animate-fade-in">
      ...
      <section className="text-center max-w-4xl mx-auto space-y-8 py-12 md:py-20">
        <div className="inline-flex items-center gap-2 px-3 py-1 bg-blue-50/70 border border-blue-200/50 rounded-full text-blue-700 text-xs font-mono font-bold tracking-wider animate-pulse">
        ...
        <h1 className="text-4xl md:text-6xl font-sans font-bold tracking-tight text-slate-900 leading-tight">
          Modern Legal Case <span className="bg-gradient-to-r from-blue-600 via-cyan-600 to-slate-950 bg-clip-text text-transparent">Management Simplified</span>
        </h1>
      ...
      <section className="bg-slate-50 border border-slate-150 rounded-3xl p-8 md:p-12 space-y-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="flex items-start gap-4">
            <div className="w-8 h-8 rounded-full bg-cyan-100 flex items-center justify-center text-cyan-600 shrink-0 mt-0.5">
      ...
      <section className="bg-gradient-to-r from-slate-950 via-slate-900 to-blue-950 text-white rounded-3xl p-8 md:p-16 text-center space-y-6 shadow-xl relative overflow-hidden">
        ...
        <div className="pt-2 relative z-10">
          <button
            onClick={() => onNavigate("dashboard")}
            className="px-8 py-4 bg-white hover:bg-slate-100 text-slate-950 font-mono font-bold text-xs uppercase tracking-widest rounded-xl transition-all shadow-md flex items-center justify-center gap-2 mx-auto cursor-pointer active:scale-98"
          >
    ...
    <div className="space-y-16 py-4 animate-fade-in max-w-4xl mx-auto text-left">
      <section className="text-center space-y-4 py-8">
        <h1 className="text-3xl md:text-5xl font-sans font-bold tracking-tight text-slate-900">
          About <span className="bg-gradient-to-r from-blue-600 to-cyan-500 bg-clip-text text-transparent">VERITAS</span>
        </h1>
  ...
  return (
    <div className="space-y-16 py-4 animate-fade-in max-w-5xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-stretch max-w-4xl mx-auto">
        ...
        {/* Pro Plan */}
        <div className="bg-slate-950 border-2 border-blue-600 rounded-3xl p-8 flex flex-col justify-between shadow-lg relative text-left text-white transform md:scale-102">
          {/* Most Popular Ribbon */}
          <div className="absolute -top-3.5 right-6 bg-gradient-to-r from-blue-600 to-cyan-500 text-white text-[10px] font-mono font-bold uppercase tracking-widest px-3 py-1 rounded-full shadow-sm">
            Most Popular
          </div>

          <div className="space-y-6">
            <div className="space-y-2">
              <h3 className="text-xl font-sans font-bold text-white">VERITAS Pro Annual</h3>
              <p className="text-blue-200 text-xs">For high-scale advocate practices requiring unlimited storage.</p>
            </div>
            
            <div className="flex items-baseline gap-1">
              <span className="text-4xl font-sans font-bold text-white">₹999</span>
              <span className="text-blue-200 text-xs font-mono">/ YEAR</span>
            </div>

            <hr className="border-slate-800" />

            <div className="space-y-3.5">
              <span className="text-xs font-mono font-bold text-blue-200 uppercase tracking-widest block">What's Included:</span>
              <ul className="space-y-2.5 text-blue-100 text-xs">
                <li className="flex items-center gap-2.5">
          ...
          <div className="pt-8 space-y-3">
            {isPro ? (
              <div className="text-center py-3 bg-blue-950/40 border border-blue-900 rounded-xl text-xs text-blue-200 font-mono font-bold uppercase tracking-wider">
                ✓ PRO SUBSCRIPTION ACTIVE
              </div>
            ) : (
              <button
                onClick={onUpgrade}
                className="w-full py-4 bg-gradient-to-r from-blue-600 to-cyan-500 hover:opacity-95 text-white font-mono font-bold text-xs uppercase tracking-widest rounded-xl transition-all shadow-md cursor-pointer text-center hover:scale-102 animate-pulse"
              >
                Upgrade to Pro
              </button>
            )}
...
export function UpgradeModal({ onClose, onConfirmUpgrade }: UpgradeModalProps) {
  return (
    <div className="fixed inset-0 z-50 bg-slate-900/60 backdrop-blur-xs flex items-center justify-center p-4 animate-fade-in" id="upgrade-modal">
      <div className="bg-white border-2 border-slate-900 max-w-md w-full rounded-2xl p-6 md:p-8 space-y-6 shadow-2xl text-left animate-zoom-in" id="upgrade-modal-card">
        ...
        <div className="flex flex-col sm:flex-row gap-2 pt-2">
          <button
            ...
            className="flex-1 px-4 py-3 bg-gradient-to-r from-blue-600 to-cyan-500 hover:from-blue-700 hover:to-cyan-600 text-white font-mono font-bold text-xs uppercase tracking-wider rounded-xl transition-all shadow-md text-center cursor-pointer"
